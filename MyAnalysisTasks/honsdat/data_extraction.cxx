            ...
            if(track.has_mcParticle()){
                ...
                if (abs(mcParticle.pdgCode())==13) {
                    ...
                    // write to textfile
                        ...
                        auto muTrackType = track.trackType();
                        ...
                        muonTracksOut << muID << "," << muRecoEta << "," << muRecoPt << "," << muRecoP << "," << muRecoPhi << "," << muMotherPDG << "," << std::to_string(muCluster) <<","<< std::to_string(track.trackType()) <<"," << muDCA << "," << muChi2 << "," << muChi2MCHMID << "," << muChi2MCHMFT << "," << isPrompt << std::endl;
